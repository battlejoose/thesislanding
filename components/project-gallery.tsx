...
export default function ProjectGallery({theme,motion,selected,onSelect}:{theme:Theme;motion:boolean;selected:string|null;onSelect:(id:string)=>void}){
