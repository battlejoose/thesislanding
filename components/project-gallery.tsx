...
export default function ProjectGallery({theme,motion,selected,onSelect,displayScale=1,cursorTilt=false,projectList=projects,webgl=true,onReady}:{theme:Theme;motion:boolean;selected:string|null;onSelect:(id:string)=>void;displayScale?:number;cursorTilt?:boolean;projectList?:Project[];webgl?:boolean|null;onReady?:()=>void}){
