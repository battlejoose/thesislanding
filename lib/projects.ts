...
export const projects: Project[] = [
  { id: 'live', name: 'Zcash Cat', ticker: 'ZCASHCAT', category: 'Token', description: 'Live on pump.fun.', cap: 'N/A', change: 'N/A', image: '/media/token-art.webp', x: null, telegram: null, icon: '⚄', color: '#d4ec6e', featured: true, token: '3rbmAAonWqxmPJ7rzQUHyZtqwqrF54EZa3pJgphmpump' },
