// Tracks the graphics and token images the page waits on before it
...
export type Stage = 'typography' | 'world' | 'images' | 'gallery';
export const STAGES: readonly Stage[] = ['typography', 'world', 'images', 'gallery'];
...
// Used by the watchdog if a stage stalls. Boot is one-way: once lifted it never re-arms, so a later
